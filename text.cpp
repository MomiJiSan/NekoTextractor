...
const char* HOOK_SEARCH_STARTING_VIEW_CONSOLE = u8"Hook search started. Keep advancing text in the game; results will appear when the search is ready.";
const wchar_t* QUICK_START = LR"(Textractor quick start:
...
const wchar_t* SELECT_PROCESS_FIRST = L"Textractor: attach or launch a game process first.";
const wchar_t* ATTACH_SUCCESS_NEXT = L"Textractor: attached to %s. Next: select the thread with game text. If no text appears, use Search for hooks and advance text in the game.";
...
const char* UI_LANGUAGE = u8"Language";
